    ...
    def topics_creation(self,
        ...
        if umap_model is None:
            umap_model = UMAP(n_neighbors = 15,
                              ...
                              random_state = 1001)
        if not embeddings:
            self.topic_model = BERTopic(umap_model = umap_model,
            ...
            self.topic_model = BERTopic(umap_model = umap_model,
                                        ...
                                        min_topic_size=min_topic_size,
                                        nr_topics=nr_topics)
        self.topic_corpus = self.clear_text(self.data['abstract'],
                                            stop_words = stop_words,
                                            lowercase = True, rmv_accents = True,
