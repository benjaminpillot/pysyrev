...
ds = pd.read_csv("/home/benjaminpillot/Documents/PRO/"
                 ...
                 lineterminator='\n')
ds_oa = ds.iloc[0:200]
oa = OpenAlexDataset(bib_dataset=ds_oa)

wos = WosDataset(bibfile="/home/benjaminpillot/Documents/PRO/"
                         "ABM_LITERATURE_REVIEW/WoS/DECEMBER_2025/savedrecs_test.bib")
wos_oa = wos.merge([oa])
wos_oa.to_csv("/home/benjaminpillot/Documents/PRO/ABM_LITERATURE_REVIEW/PYSYREV/wos_oa.csv")
